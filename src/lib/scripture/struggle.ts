...
const SYNONYMS: Record<string, { en: string[]; am?: string[] }> = {
  adultery: { en: ["adulter", "cheat on", "cheated on", "cheating on", "affair", "unfaithful", "another man's wife", "another woman's husband"], am: ["ምንዝር", "አመነዘር"] },
  lust: { en: ["lust", "porn", "pornograph", "masturbat", "sexual thought", "desire for her", "desire for him", "impure thought"], am: ["ምኞት", "ፍትወት", "ፖርን"] },
  ...
  violence: { en: ["violen", "hit my", "beat my", "hurt someone"], am: ["ደበደብ", "መታሁ", "ግፍ"] },
  ...
  theft: { en: ["steal", "stole", "stolen", "theft", "thief", "shoplift", "took money"], am: ["ስርቆት", "ሰረቅ", "ሌብነት", "ሌባ"] },
  ...
  pride: { en: ["pride", "proud", "arrogan", "ego", "vain", "better than others", "look down on"], am: ["ትዕቢት", "ኩራት", "ትምክህት"] },
  ...
  denial: { en: ["denied", "deny", "ashamed of my faith", "ashamed of jesus", "hid my faith"], am: ["ካድ", "ክህደት"] },
