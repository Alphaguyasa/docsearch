...
/**
 * Collapsible list of ALL retrieved passages with their fusion scores.
 *
 * Shows everything retrieved, not just what the answer cited — so a reader can
 * see what the model was given and judge what it chose to leave out.
 */
            ...
            <li key={s.n} className="px-3 py-2">
              <div className="flex items-baseline justify-between gap-3 text-xs">
                <div className="flex min-w-0 items-baseline gap-2">
                  <span className="shrink-0 font-mono text-muted">[{s.n}]</span>
